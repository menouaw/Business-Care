...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    if ($action === 'delete' && $employee_id > 0) {
        ...
        exit;
    } elseif ($action === 'edit' && $employee_id > 0) {



        flashMessage('Fonctionnalité de modification non implémentée.', 'info');
        redirectTo(WEBCLIENT_URL . '/modules/companies/employees.php');
        exit;
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-3">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="#" class="btn btn-sm btn-primary"> <!-- TODO: Lien vers ajout/invitation salarié -->
                        ...
                        <?php else: ?>
                            <?php foreach ($employees as $employee): ?>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <a href="<?php echo WEBCLIENT_URL; ?>/modules/companies/employees.php?action=edit&id=<?= $employee['id'] ?>" class="btn btn-sm btn-outline-primary me-1" title="Voir/Modifier">
                                            <i class="fas fa-eye"></i>
                                        </a>

                                        <?php if ($employee['statut'] === 'actif'): ?>
                                            <a href="<?php echo WEBCLIENT_URL; ?>/modules/companies/employees.php?action=delete&id=<?= $employee['id'] ?>"
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo WEBCLIENT_URL; ?>/modules/companies/employees.php?action=reactivate&id=<?= $employee['id'] ?>"
