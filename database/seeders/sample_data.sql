...
INSERT INTO personnes (nom, prenom, email, firebase_uid, telephone, date_naissance, genre, photo_url, role_id, entreprise_id, site_id, statut, derniere_connexion) VALUES
('Admin', 'System', 'admin@businesscare.fr', '7NSSEzdbnOZFYEpLhT5TJBZI4ct1', '0000000000', '1990-01-01', 'Autre', '/assets/images/icons/default-user.png', 1, NULL, NULL, 'actif', NOW()),
('Salarie', 'Test', 'salarie@businesscare.fr', NULL, '0000000000', '1990-01-01', 'Autre', '/assets/images/icons/default-user.png', 2, NULL, NULL, 'actif', NOW()), 
('Prestataire', 'Test', 'prestataire@businesscare.fr', NULL, '0000000000', '1990-01-01', 'Autre', '/assets/images/icons/default-user.png', 3, NULL, NULL, 'actif', NOW()), 
('Entreprise', 'Test', 'entreprise@businesscare.fr', NULL, '0000000000', '1990-01-01', 'Autre', '/assets/images/icons/default-user.png', 4, NULL, NULL, 'actif', NOW()), 
('Dupont', 'Marie', 'marie.dupont@techsolutions.fr', NULL, '0612345678', '1990-05-15', 'F', '/assets/images/icons/default-user.png', 2, 1, 1, 'actif', NOW() - INTERVAL 1 DAY), 
('Martin', 'Jean', 'jean.martin@santeplus.fr', NULL, '0623456789', '1985-08-20', 'M', '/assets/images/icons/default-user.png', 2, 2, 2, 'actif', NOW() - INTERVAL 2 DAY), 
('Bernard', 'Chloe', 'chloe.bernard@bienetrecorp.fr', NULL, '0634567890', '1992-03-10', 'F', '/assets/images/icons/default-user.png', 2, 3, 4, 'actif', NOW() - INTERVAL 3 DAY), 
('Dubois', 'Pierre', 'pierre.dubois@techsolutions.fr', NULL, '0645678901', '1988-12-05', 'M', '/assets/images/icons/default-user.png', 2, 1, 1, 'actif', NOW() - INTERVAL 4 DAY), 
('Robert', 'Lucas', 'lucas.robert@santeplus.fr', NULL, '0667890123', '1991-04-15', 'M', '/assets/images/icons/default-user.png', 2, 2, 2, 'actif', NOW() - INTERVAL 5 DAY), 
('Richard', 'Julie', 'julie.richard@bienetrecorp.fr', NULL, '0678901234', '1987-09-30', 'F', '/assets/images/icons/default-user.png', 2, 3, 3, 'actif', NOW() - INTERVAL 6 DAY), 
('Durand', 'Sophie', 'sophie.durand@santeplus.fr', NULL, '0689012345', '1993-02-20', 'F', '/assets/images/icons/default-user.png', 3, NULL, NULL, 'actif', NOW() - INTERVAL 7 DAY), 
('Moreau', 'Hugo', 'hugo.moreau@techsolutions.fr', NULL, '0690123456', '1996-06-25', 'M', '/assets/images/icons/default-user.png', 2, 1, 1, 'actif', NOW() - INTERVAL 8 DAY), 
('Duamel', 'Heloise', 'duamelle.heloise@bienetrecorp.fr', NULL, '0612345677', '1995-03-15', 'F', '/assets/images/icons/default-user.png', 2, 3, 3, 'actif', NOW() - INTERVAL 9 DAY), 
('Dupois', 'Jacques', 'jacques.dupois@techsolutions.fr', NULL, '0612345666', '1995-03-15', 'M', '/assets/images/icons/default-user.png', 2, 1, 1, 'inactif', NOW() - INTERVAL 10 DAY),
('Representant', 'SantePlus', 'rep.santeplus@businesscare.fr', NULL, '0000000001', '1980-01-01', 'Autre', '/assets/images/icons/default-user.png', 4, 2, 2, 'actif', NOW()),
('Lefevre', 'Camille', 'camille.lefevre@santeplus.fr', NULL, '0611223344', '1994-11-25', 'F', '/assets/images/icons/default-user.png', 2, 2, 2, 'actif', NOW() - INTERVAL 1 DAY),
('Girard', 'Thomas', 'thomas.girard@techsolutions.fr', NULL, '0622334455', '1989-07-12', 'M', '/assets/images/icons/default-user.png', 2, 1, 1, 'actif', NOW() - INTERVAL 2 DAY),
('Bonnet', 'Elodie', 'elodie.bonnet@bienetrecorp.fr', NULL, '0633445566', '1991-01-30', 'F', '/assets/images/icons/default-user.png', 2, 3, 3, 'actif', NOW() - INTERVAL 3 DAY),
('Roux', 'Antoine', 'antoine.roux@financeconseil.fr', NULL, '0644556677', '1987-03-18', 'M', '/assets/images/icons/default-user.png', 2, 4, 5, 'actif', NOW() - INTERVAL 4 DAY),
('David', 'Laura', 'laura.david@retailexpress.com', NULL, '0655667788', '1993-09-05', 'F', '/assets/images/icons/default-user.png', 2, 5, 7, 'actif', NOW() - INTERVAL 5 DAY),
('Morel', 'Nicolas', 'nicolas.morel@eduforma.org', NULL, '0666778899', '1990-06-15', 'M', '/assets/images/icons/default-user.png', 2, 6, 9, 'actif', NOW() - INTERVAL 6 DAY),
('Fournier', 'Manon', 'manon.fournier@buildinnov.fr', NULL, '0677889900', '1995-12-01', 'F', '/assets/images/icons/default-user.png', 2, 7, 11, 'actif', NOW() - INTERVAL 7 DAY),
('Garcia', 'Alexandre', 'alexandre.garcia@greentechenergy.com', NULL, '0688990011', '1986-08-22', 'M', '/assets/images/icons/default-user.png', 2, 8, 12, 'actif', NOW() - INTERVAL 8 DAY),
('Rodriguez', 'Pauline', 'pauline.rodriguez@agribiosolutions.fr', NULL, '0699001122', '1992-04-10', 'F', '/assets/images/icons/default-user.png', 2, 9, 13, 'inactif', NOW() - INTERVAL 9 DAY),
('Martinez', 'Julien', 'julien.martinez@transportrapide.fr', NULL, '0600112233', '1988-10-28', 'M', '/assets/images/icons/default-user.png', 2, 10, 15, 'actif', NOW() - INTERVAL 10 DAY),
('Blanc', 'Mathilde', 'mathilde.blanc@psychologue.pro', NULL, '0711223344', '1985-02-14', 'F', '/assets/images/icons/default-user.png', 3, NULL, NULL, 'actif', NOW() - INTERVAL 1 DAY),
('Petit', 'Romain', 'romain.petit@coach-bienetre.com', NULL, '0722334455', '1980-11-03', 'M', '/assets/images/icons/default-user.png', 3, NULL, NULL, 'actif', NOW() - INTERVAL 2 DAY),
('Sanchez', 'Emma', 'emma.sanchez@nutritionniste-conseil.fr', NULL, '0733445566', '1990-09-19', 'F', '/assets/images/icons/default-user.png', 3, NULL, NULL, 'actif', NOW() - INTERVAL 3 DAY),
('Mercier', 'Leo', 'leo.mercier@sophrologue-paris.fr', NULL, '0744556677', '1978-05-05', 'M', '/assets/images/icons/default-user.png', 3, NULL, NULL, 'en_attente', NOW() - INTERVAL 4 DAY),
('Chevalier', 'Ines', 'ines.chevalier@reflexologue-lyon.com', NULL, '0755667788', '1983-03-29', 'F', '/assets/images/icons/default-user.png', 3, NULL, NULL, 'actif', NOW() - INTERVAL 5 DAY),
('Perez', 'Hugo', 'hugo.perez@formateur-secourisme.org', NULL, '0766778899', '1986-12-11', 'M', '/assets/images/icons/default-user.png', 3, NULL, NULL, 'actif', NOW() - INTERVAL 6 DAY),
('Andre', 'Louise', 'louise.andre@hypnotherapeute.net', NULL, '0777889900', '1975-01-20', 'F', '/assets/images/icons/default-user.png', 3, NULL, NULL, 'actif', NOW() - INTERVAL 7 DAY),
('Fernandez', 'Gabriel', 'gabriel.fernandez@coach-image.pro', NULL, '0788990011', '1989-04-08', 'M', '/assets/images/icons/default-user.png', 3, NULL, NULL, 'suspendu', NOW() - INTERVAL 8 DAY),
('Gauthier', 'Alice', 'alice.gauthier@techsolutions.fr', NULL, '0612121212', '1996-02-18', 'F', '/assets/images/icons/default-user.png', 2, 1, 1, 'actif', NOW() - INTERVAL 1 DAY),
('Henry', 'Raphael', 'raphael.henry@santeplus.fr', NULL, '0623232323', '1992-10-01', 'M', '/assets/images/icons/default-user.png', 2, 2, 2, 'actif', NOW() - INTERVAL 2 DAY),
('Rousseau', 'Eva', 'eva.rousseau@bienetrecorp.fr', NULL, '0634343434', '1997-05-11', 'F', '/assets/images/icons/default-user.png', 2, 3, 4, 'actif', NOW() - INTERVAL 3 DAY),
('Nicolas', 'Adam', 'adam.nicolas@financeconseil.fr', NULL, '0645454545', '1994-08-07', 'M', '/assets/images/icons/default-user.png', 2, 4, 5, 'actif', NOW() - INTERVAL 4 DAY),
('Leclerc', 'Clara', 'clara.leclerc@retailexpress.com', NULL, '0656565656', '1991-03-22', 'F', '/assets/images/icons/default-user.png', 2, 5, 6, 'actif', NOW() - INTERVAL 5 DAY),
('Perrin', 'Louis', 'louis.perrin@eduforma.org', NULL, '0678787878', '1988-11-16', 'M', '/assets/images/icons/default-user.png', 2, 6, 10, 'inactif', NOW() - INTERVAL 6 DAY),
('Morin', 'Zoe', 'zoe.morin@buildinnov.fr', NULL, '0689898989', '1993-01-09', 'F', '/assets/images/icons/default-user.png', 2, 7, 11, 'actif', NOW() - INTERVAL 7 DAY),
('Mathieu', 'Arthur', 'arthur.mathieu@greentechenergy.com', NULL, '0690909090', '1995-07-31', 'M', '/assets/images/icons/default-user.png', 2, 8, 12, 'actif', NOW() - INTERVAL 8 DAY),
('Clement', 'Rose', 'rose.clement@agribiosolutions.fr', NULL, '0601010101', '1998-04-20', 'F', '/assets/images/icons/default-user.png', 2, 9, 13, 'actif', NOW() - INTERVAL 9 DAY),
('Guerin', 'Theo', 'theo.guerin@transportrapide.fr', NULL, '0613131313', '1990-12-24', 'M', '/assets/images/icons/default-user.png', 2, 10, 14, 'actif', NOW() - INTERVAL 10 DAY),
('Representant', 'TechSolutions', 'rep.techsolutions@businesscare.fr', NULL, '0000000002', '1975-05-10', 'Autre', '/assets/images/icons/default-user.png', 4, 1, 1, 'actif', NOW()),
('Representant', 'RetailExpress', 'rep.retailexpress@businesscare.fr', NULL, '0000000003', '1982-09-15', 'Autre', '/assets/images/icons/default-user.png', 4, 5, 6, 'suspendu', NOW());
