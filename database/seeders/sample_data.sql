...
('salarie', 'Salarié d''une entreprise cliente');
...
('Santé Plus', '98765432109876', '456 Avenue de la Santé', '75002', 'Paris', '01 98 76 54 32', 'contact@santeplus.fr', 'www.santeplus.fr', '/logos/santeplus.png', '201-500', 'Santé', '2019-06-20'),
('Bien-être Corp', '45678901234567', '789 Boulevard du Bien-être', '75003', 'Paris', '01 45 67 89 01', 'contact@bienetrecorp.fr', 'www.bienetrecorp.fr', '/logos/bienetrecorp.png', '11-50', 'Bien-être', '2021-03-10');
...
('Consultation Psychologique', 'Séance individuelle de 45 minutes avec un psychologue qualifié', 80.00, 45, 'consultation', 'Santé mentale', 'intermediaire', 1, 'Aucun', 'Aucun'),
('Yoga en Entreprise', 'Séance de yoga adaptée au milieu professionnel', 120.00, 60, 'atelier', 'Bien-être physique', 'debutant', 20, 'Tapis de yoga', 'Aucun'),
...
('Conférence Bien-être', 'Conférence sur les bonnes pratiques de bien-être', 200.00, 120, 'conference', 'Formation', 'intermediaire', 100, 'Aucun', 'Aucun'),
('Défi Sportif Mensuel', 'Programme d''activités physiques sur un mois', 180.00, 30, 'evenement', 'Sport', 'avance', 30, 'Tenue de sport', 'Niveau intermédiaire');
...
(1, '2024-01-01', '2024-12-31', 5000.00, 150, 'premium', 'actif', 'Accès à toutes les prestations premium'),
(2, '2024-02-01', '2024-12-31', 7500.00, 300, 'entreprise', 'actif', 'Accès illimité aux prestations'),
(3, '2024-03-01', '2024-12-31', 2500.00, 35, 'standard', 'en_attente', 'Accès aux prestations de base');
...
(1, 1, '2024-03-20 10:00:00', 45, 'Cabinet 101', 'presentiel', 'planifie', 'Première consultation'),
(2, 2, '2024-03-21 14:00:00', 60, 'Salle de yoga', 'presentiel', 'confirme', 'Séance de groupe'),
...
('Conférence sur le Bien-être au Travail', 'Une conférence interactive sur les bonnes pratiques', '2024-04-01 09:00:00', '2024-04-01 11:00:00', 'Salle de Conférence Paris', 'conference', 100, 'intermediaire', 'Aucun', 'Aucun'),
...
('Yoga & Méditation', 'Groupe de pratique du yoga et de la méditation', 'bien_etre', 'debutant', 20),
('Running Club', 'Club de course à pied pour tous niveaux', 'sport', 'intermediaire', 30),
('Nutrition & Santé', 'Groupe d''échange sur la nutrition et la santé', 'sante', 'intermediaire', 25);

INSERT INTO dons (personne_id, montant, type, description, date_don, statut) VALUES
(1, 50.00, 'financier', 'Don pour le programme de bien-être', '2024-03-01', 'valide'),
(2, NULL, 'materiel', 'Don de matériel informatique', '2024-03-15', 'en_attente');

INSERT INTO evaluations (personne_id, prestation_id, note, commentaire, date_evaluation) VALUES
(1, 1, 5, 'Excellent service, très professionnel', '2024-03-10'),
(2, 2, 4, 'Très bonne séance, à recommander', '2024-03-12'),
(3, 3, 5, 'Formation très enrichissante', '2024-03-15');

INSERT INTO notifications (personne_id, titre, message, type, lien, lu, date_lecture) VALUES
(1, 'Nouveau Rendez-vous', 'Votre rendez-vous a été confirmé', 'success', '/rendez-vous/1', false, NULL),
(2, 'Paiement Reçu', 'Votre paiement a été reçu avec succès', 'success', '/factures/1', true, '2024-03-17 10:30:00'),
(3, 'Nouvel Événement', 'Un nouvel événement est disponible', 'info', '/evenements/2', false, NULL); 