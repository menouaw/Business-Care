...
$event['date_debut_formatted'] = $event['date_debut'] ? (new DateTime($event['date_debut']))->format('Y-m-d\TH:i') : '';
$event['date_fin_formatted'] = $event['date_fin'] ? (new DateTime($event['date_fin']))->format('Y-m-d\TH:i') : '';

$event['organise_par_bc'] = $event['organise_par_bc'] ? '1' : '0';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validateToken($_POST['csrf_token'] ?? '')) {
        handleCsrfFailureRedirect($id, 'events', 'modification evenement');
    } else {
        ...
        $result = eventsSave($formData, $id);

        if ($result['success']) {
            flashMessage($result['message'], 'success');
            
            redirectTo(WEBADMIN_URL . '/modules/events/view.php?id=' . $id);
        } else {
...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="card">
                <div class="card-header">Informations de l'evenement</div>
                <div class="card-body">
                    <form action="edit.php?id=<?php echo $id; ?>" method="POST">
                        ...
                        <div class="row mb-3">
                         ...
                         <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" class="form-control <?php echo isset($errors['date_debut']) ? 'is-invalid' : ''; ?>" id="date_debut" name="date_debut" value="<?php echo htmlspecialchars($formData['date_debut_formatted'] ?? ''); ?>" required>
                             ...
                             <div class="col-md-6">
                                ...
                                <input type="datetime-local" class="form-control <?php echo isset($errors['date_fin']) ? 'is-invalid' : ''; ?>" id="date_fin" name="date_fin" value="<?php echo htmlspecialchars($formData['date_fin_formatted'] ?? ''); ?>">
                         ...
                         <div class="row mb-3">
                             ...
                             <div class="col-md-6">
                                <label for="lieu" class="form-label">Lieu (si pas de site)</label>
                        ...
                        <a href="<?php echo WEBADMIN_URL; ?>/modules/events/view.php?id=<?php echo $id; ?>" class="btn btn-secondary">Annuler</a>
                    </form>
                </div>
            </div>
