...
$pageTitle = "Ajouter une conférence";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validateToken($_POST['csrf_token'] ?? '')) {
        handleCsrfFailureRedirect(0, 'conferences', 'création conférence');
    } else {
        ...
        $dataToSave['site_id'] = empty($dataToSave['site_id']) ? null : (int)$dataToSave['site_id'];
        
         $dataToSave['capacite_max'] = empty($dataToSave['capacite_max']) ? null : (int)$dataToSave['capacite_max'];
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                     <form action="<?php echo WEBADMIN_URL; ?>/modules/conferences/add.php" method="post" novalidate>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select <?php echo isset($errors['site_id']) ? 'is-invalid' : ''; ?>" id="site_id" name="site_id">
                                    ...
                                    <?php foreach ($sites as $site_id => $site_name): ?>
                                        <option value="<?php echo $site_id; ?>" <?php echo (isset($formData['site_id']) && (string)$formData['site_id'] === (string)$site_id) ? 'selected' : ''; ?>>
                        ...
                        <button type="submit" class="btn btn-primary">
                           <i class="fas fa-plus-circle me-1"></i> Ajouter la conférence
                        </button>
                         <a href="<?php echo WEBADMIN_URL; ?>/modules/conferences/index.php" class="btn btn-secondary">
                            Annuler
                         </a>
                    </form>
                </div>
